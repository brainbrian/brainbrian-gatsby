...
date: '2009-10-01'
image: './image.jpg'
url: 'http://brainbrian.com/projects/pokemon-platinum-installer.zip'
tags: ['actionscript', 'motion design', 'technical lead', 'xml']
---

Pokémon tasked POP with creating a fun gift for Pokémon fans to unlock when they purchased a game and found the code inside the packaging. Fans could then go to [pokemonplatinum.com/#/rotom/](http://www.pokemonplatinum.com/#/rotom/) with their code and download the Adobe AIR Desktop application linked to above. I was the lead developer on the project.
