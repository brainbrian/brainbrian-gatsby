        ...
        <main className="content">
            ...
            <ul className="nostyle-list limit-text-width">
                ...
                <li>
                    ...
                    <p>
                        Lead front end software engineer for the Classes/Events
                        and Adventures team. Work in a continuous integrated
                        environment with Docker, Java, Jenkins and more. Spend
                        most of my time updating our front end systems to be
                        written in ES6 linting standards with Vue.js components.
                        Use build tools like webpack and dependency management
                        on the front end is done via our private NPM repository.
                        Unit test our shared modules with Mocha and Chai.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        Second time working at POP. Previously wrote a large
                        amount of ActionScript 3, building applications and
                        animations for various clients. This time I focused
                        heavily on JavaScript. Used Node.js on almost every
                        project integrating Grunt, Gulp or webpack for build
                        tools. Used frameworks/libraries like React, Angular,
                        GreenSock, jQuery, ScrollMagic and many others. Created
                        animations in both CSS and JavaScript. Led various
                        server integrations, API and database development,
                ...
                <li>
                    ...
                    <p>
                        Led a team in development efforts and made key decisions
                        in e-commerce infrastructure, hosting architecture and
                        build systems. Developed new applications for users to
                        find and customize products. Developed responsive
                        WordPress templates for all brand sites. Researched new
                        technologies like Angular and implemented them in
                        production builds. Planned marketing and social
                        initiatives. Implemented new management communication
                        and analytic tools for team efficiencies. Set up source
                        control infrastructure. Evaluated analytics and made
                        informed online-business decisions.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        Managed a team of developers executing marketing
                        initiatives for Starbucks. Brainstormed and planned
                        technical execution on Frappuccino, Pumpkin Spice Latte
                        and Starbucks Holiday. Planned timelines and feature
                        specifications for technical execution. Utilized JIRA
                        for iteration planning. Programmed MVC based Flash
                ...
                <li>
                    ...
                    <p>
                        Built Flash based experiences for corporate clients such
                        as Target, Nintendo, Amazon, Xbox and more. Led
                        development planning efforts and execution.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        = Web development (HTML, CSS, Javascript, Ajax, Flash,
                        XML, PHP and MySQL), DVD production, In-store Media
                        Creation
                    </p>
                </li>
                <li>
                    ...
                    <h4>2006 – Present</h4>
                    <p>
                        Web-design and Programming (HTML, CSS, Javascript,
                        Flash, XML, PHP and MySQL), Custom CMS Application
                        Development
                    </p>
                </li>
                <li>
                ...
                <li>
                    <h3>
                        Co-Producer, Milwaukee Bucks “Bucks Buddy” Half-time
                        Segment
                    </h3>
                    <h4>Milwaukee, WI | 2003</h4>
                    <p>
                        I Produced, Shot, and Edited a 30 second half-time
                        segment for the “Bucks Buddy” program with partner, Brad
            ...
            <ul className="nostyle-list limit-text-width">
                <li>
                    ...
                    <p>
                        The team at POP on the Target account was awarded a Best
                        of the Bullseye award by Target Corporate for
                        collaboration.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        International Health and Medical Media Awards for Best
                        Web Site
                        <br />
